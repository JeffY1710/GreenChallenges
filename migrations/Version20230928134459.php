 ...
 */
final class Version20230928134459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_challenge ADD challenge_id INT NOT NULL, CHANGE user_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_challenge DROP challenge_id, CHANGE user_id user_id INT DEFAULT NULL');
    }
}
